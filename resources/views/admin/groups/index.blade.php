                                        ...
                                        <table class="table table-bordered table-hover" role="grid" id="dataTableDefault">
                                            ...
                                            @foreach($groups as $group)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.groups.show',$group->id) }}" title="Visualizar">
                                                            {{ $group->name }}
                                                        </a>
                                                    </td>
                                                    <td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.groups.store') }}" method="post" class="form-horizontal" autocomplete="off" accept-charset="utf-8">
                        {{ csrf_field() }}
